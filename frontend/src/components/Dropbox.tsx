                    ...
                    <div className="flex items-center gap-2">
                      {convertedFile && !convertedFile.converting && (
                        <button
                          ...
                          className="flex items-center gap-2 bg-green-500 text-white px-4 py-1 rounded-md text-[14px] font-semibold hover:bg-green-600 transition disabled:opacity-50 disabled:cursor-not-allowed"
                        >
